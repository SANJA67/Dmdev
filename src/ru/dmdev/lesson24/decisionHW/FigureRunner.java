...
public class FigureRunner {
    ...
    public static void main(String[] args) {
        Rectangle rectangle = new Rectangle(new Point(0, 100), new Point(100, 10)); // Здесь задается прямоугольник припомощи диогонали...
        Circle circle = new Circle(new Point(25, 30), 20.4); // как это...
